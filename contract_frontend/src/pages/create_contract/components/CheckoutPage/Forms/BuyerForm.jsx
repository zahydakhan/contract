        ...
        <React.Fragment>
            ...
            <Grid container spacing={3}>
                <Grid item xs={12} sm={6}>
                    <InputField variant="outlined" name={buyer_name.name} label={buyer_name.label} fullWidth value={row.buyer_name} />
                </Grid>
                <Grid item xs={12} sm={6}>
                ...
                <Grid item xs={12} sm={6}>
                    <InputField variant="outlined" name={buyer_ABN_number.name} label={buyer_ABN_number.label} fullWidth value={row.buyer_ABN_number} />
                </Grid>
                <Grid item xs={12}>
                    <InputField variant="outlined" name={buyer_street_address.name} label={buyer_street_address.label} fullWidth value={row.buyer_street_address} />
                </Grid>
                ...
                <Grid item xs={12} sm={6}>
                    <SelectField
                        ...
                        data={states}
                        fullWidth
                        defaultValue={row.buyer_state}
                        value={row.buyer_state}
                    />
                </Grid>
                <Grid item xs={12} sm={6}>
                    <InputField variant="outlined" name={buyer_post_code.name} label={buyer_post_code.label} fullWidth value={row.buyer_post_code} />
                </Grid>

                <Grid item xs={12} sm={6}>
                    <InputField variant="outlined" name={buyer_post_name.name} label={buyer_post_name.label} fullWidth value={row.buyer_post_name} />
                </Grid>
                ...
                <Grid item xs={12} sm={6}>
                    <SelectField
                        ...
                        data={countries}
                        fullWidth
                        selectedValue={row.buyer_country}
